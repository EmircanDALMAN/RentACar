...
namespace ReCapProject.Core.Constants
{
    public class Messages
    {
        ...
        public static string BrandListed = "Marka Listeleme Başarılı";
        public static string ColorsListed = "Renk Listeleme Başarılı";
        public static string CarsListed = "Araç Listeleme Başarılı";
    }
}
